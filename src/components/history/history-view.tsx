        ...
        {selectedDayModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            <motion.div
              ...
              className="glass-card w-full max-w-lg p-6 rounded-3xl border border-slate-700 space-y-6 bg-slate-900/95 shadow-2xl"
            >
              ...
              {modalLogs.length === 0 ? (
                ...
                <div className="space-y-3 max-h-80 overflow-y-auto pr-1">
                  {modalLogs.map(log => {
                    ...
                    const slot = slots.find(sl => sl.id === log.timetable_slot_id);
                    return (
                      <div key={log.id} className="p-3.5 rounded-2xl bg-slate-800/60 border border-slate-700/80 flex flex-col gap-3">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
        ...
        {selectedSubjectModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
            <motion.div
              ...
              className="bg-slate-900 border border-slate-700/80 rounded-3xl p-6 max-w-lg w-full shadow-2xl space-y-5"
            >
              {(() => {
