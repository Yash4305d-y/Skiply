    ...
    <footer className="border-t border-slate-800/60 bg-transparent py-8 text-slate-400 text-xs mt-auto pb-20 md:pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <NextLink href="/onboarding" className="link-interactive text-slate-400">AI Onboarding</NextLink>
          <NextLink href="/dashboard" className="link-interactive text-slate-400">Safe Skips Math</NextLink>
          <NextLink href="/history" className="link-interactive text-slate-400">Audit History</NextLink>
