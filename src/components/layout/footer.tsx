    ...
    <footer className="border-t border-slate-800/60 bg-slate-950 py-8 text-slate-400 text-xs mt-auto pb-20 md:pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <NextLink href="/onboarding" className="hover:text-indigo-400 transition-colors">AI Onboarding</NextLink>
          <NextLink href="/dashboard" className="hover:text-indigo-400 transition-colors">Safe Skips Math</NextLink>
          <NextLink href="/history" className="hover:text-indigo-400 transition-colors">Audit History</NextLink>
